<%@ Page Title="Create SAR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SAR.aspx.cs" Inherits="Authy.Pages.SAR" MaintainScrollPositionOnPostback="true" Async="true" %>
        ...
        <ContentTemplate>
            <asp:MultiView ID="MultiView_SARForm" runat="server" ActiveViewIndex="0">
                <asp:View ID="View_Create" runat="server">
                    ...
                    <!-- Authorizations -->
                    <br />
                    <uc1:SelectAuthorizations runat="server" id="SelectAuthorizations" OnSelectGroupClick="SelectAuthorizations_SelectGroupClick"/>
                     <br /> <div class="row">
                            
                                        
                                    <div class="col-xs-12 col-sm-8">
                                         <label style="font-weight:bold; font-size:18px; padding-left:15px">Is it a new employee request?</label> <asp:CheckBox ID="cb_isNewEmployeeRequest" runat="server" Visible="false"/>&nbsp <asp:LinkButton ID="lb_isNewEmployeeRequest" runat="server" ForeColor="gray" ToolTip="Click to change the status." OnClick="lb_isNewEmployeeRequest_Click"><i id="i_isNewEmployeeRequest" runat="server" class="glyphicon glyphicon-remove">  No </i></asp:LinkButton>
                                    </div>
                        </div>
                    <hr />
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-sm-offset-4">
                                <asp:LinkButton ID="LinkButton_Review" runat="server" CssClass="btn btn-default btn-block btn-lg" ForeColor="White" BorderStyle="None" BackColor="YellowGreen" OnClick="LinkButton_Review_Click">
                    ...
                    <div class="container-fluid block-gray">
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4" style="text-align: center">
                                ...
                                <h4 style="font-weight: bold">Step 4 of 4: Review and Submit SAR</h4>
                            </div>
                        </div>
                        <hr />
                         <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <asp:BulletedList ID="BulletedList_SelectedEmployees" runat="server" Font-Bold="true" BulletStyle="Numbered" OnLoad="BulletedList_SelectedEmployees_Load"></asp:BulletedList>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <asp:BulletedList ID="BulletedList_SelectedAuthorizations" runat="server" Font-Bold="true" BulletStyle="Numbered" OnLoad="BulletedList_SelectedAuthorizations_Load"></asp:BulletedList>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                Is it a new employee reuqest? <asp:Label runat="server" ID="label_newRequest" Font-Bold="true" OnLoad="label_newRequest_Load"></asp:Label>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                        ...
                        <div class="row" style="display:none">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2" style="text-align:center">
                                ...
                                I agree that the above SAR information is correct and that I have permission to create this SAR.
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-sm-offset-4">
                                ...
                                <asp:LinkButton ID="LinkButton_Submit" runat="server" CssClass="btn btn-default btn-block btn-lg" BorderStyle="None" ForeColor="White" BackColor="YellowGreen" OnCommand="LinkButton_Submit_Command" CommandName="NextView">
                                    Submit SAR
                                </asp:LinkButton>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12" style="text-align: center">
                                <asp:Panel runat="server" ID="sucessfulPannel">
                                    Your SAR has been submitted for approval, and you will get an email whether approved or declined. In the meantime, you can view its status <a href="ViewRequests.aspx">here</a> or submit a new SAR <a href="SAR.aspx">here</a>.
                                </asp:Panel>
